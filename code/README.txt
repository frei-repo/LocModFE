...
* on www.dealii.org.
*
* Then, one possibility is to create a subdirectory
* 
* step-modfe
*
* in the deal.II examples folder that comes with the installation.
*
* Unpack all source files in this folder. Go to the build folder and type the 
